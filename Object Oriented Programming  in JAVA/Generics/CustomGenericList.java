...
/*
 * Real WildCard
 * public getClass(List<? extends Number> List)
 todo: Means we can pass Number as well as the subclass of the Number. If we only write List<Number>, then we can only pass Number type.
 */
